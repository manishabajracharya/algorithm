...
if(str.charAt(0)=='x' &str.charAt(1)=='h' && str.length()>=3)
{
...
public int bunnyEars(int bunnies) {
  if(bunnies<=0)
  return 0;
  else return (2+ bunnyEars(--bunnies));
}
/*
...
public String parenBit(String str) {
  ...
  else return parenBit(str.substring(1, str.length()-1));
}
public String parenBit(String str) {
  if (str.charAt(0) != '(') {
    return parenBit(str.substring(1));
...
public boolean strCopies(String str, String sub, int n) {
  if(sub.length()>str.length()) return (n<=0);
...
public boolean nestParen(String str) {
  ...
  else if(str.charAt(0)!='(') return nestParen(str.substring(1));
  
  else return nestParen(str.substring(0, str.length()-1));
